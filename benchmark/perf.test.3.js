...
//const fileNamePath = path.join(__dirname, "../test/assets/ptest.xml");//with CDATA
//const fileNamePath = path.join(__dirname, "../test/assets/ptest_with_prolog.xml");//with CDATA
const fileNamePath = path.join(__dirname, "../test/assets/sample.xml");//1.5k
//const fileNamePath = path.join(__dirname, "../test/assets/midsize.xml");//13m
